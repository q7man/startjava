...
public class GuessNumberTest {
    public static void main(String[] args) {
        ...
        while (variable = true) {
            guessNum.guess();
            if (playerOne.number == guessNum.guessnumber || playerTwo.number == guessNum.guessnumber || playerOne.number != guessNum.guessnumber || playerTwo.number != guessNum.guessnumber)
                do {
